...
O projeto não tem backend, build ou dependências npm. É HTML puro.
...
**GitHub Pages:**
Suba a pasta para um repositório e ative o GitHub Pages apontando para a branch `main`, raiz `/`.

**Localmente:**
Use o Live Server do VS Code ou qualquer servidor HTTP simples. Abrir como `file://` também funciona, já que o `index.html` standalone tem tudo embutido.
